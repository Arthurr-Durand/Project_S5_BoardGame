...
\section{Représentation du monde}
    ...
    \subsection{Plateau de jeu}\label{part:geometry}
        ...
        \end{figure}
        \footnotetext{Source: \url{https://fr.wikipedia.org/wiki/Pavage_hexagonal}}
        \footnotetext{Source: \url{https://fr.wikipedia.org/wiki/Pavage_carr\%C3\%A9}}
        \footnotetext{Source: \url{https://fr.wikipedia.org/wiki/Pavage_triangulaire}}
